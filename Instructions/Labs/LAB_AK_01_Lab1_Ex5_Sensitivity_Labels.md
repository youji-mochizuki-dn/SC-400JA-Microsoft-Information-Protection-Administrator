...
5. 「信頼されていないリポジトリ セキュリティ」ダイアログの「はい」の **Y** を入力して確認し、Enter キーを押します。  完了するまでに数秒かかる場合があります。
...
5. 「**新しい秘密度ラベル**」ウィザードが起動します。「**名前**」で、「**名前**」、「**管理者向けの説明**」、「**ユーザー向けの説明**」のラベル ページのツールチップを作成し、次の情報を入力します。
...
18. 「**新しい秘密度ラベル**」ウィザードが起動します。「**名前**」で、「**名前**」、「**管理者向けの説明**」、「**ユーザー向けの説明**」のラベル ページのツールチップを作成し、次の情報を入力します。
...
22. 「**ファイルと電子メールの保護設定を定義する**」ページで、「**ファイルと電子メールを暗号化**」オプションを選択します
...
32. 「**データベースの列の自動ラベル付け**」ページで、「**次へ**」をクリックします。 
...
15. 「**Power BI のポリシー設定**」ページで「**次へ**」を選択します。
...
3. **Microsoft 365 コンプライアンス センター**の左側のナビゲーション ペインで、「**情報保護**」を選択します。  

4. 「情報保護」ページで、既存の「**内部**」ラベルを (選択せずに) 強調表示し、省略記号 (3 つの点) を選択します。

5. 「**+ サブ ラベルの追加**」メニュー項目を選択します。

6. 「**新しい秘密度ラベル**」ウィザードが起動します。「**名前**」で、ラベル ページのツールチップを作成し、次の情報を入力します。
...
10. 「**ファイルと電子メールの自動ラベル付け**」ページで、「**ファイルと電子メールの自動ラベル付け**」を有効に設定します。
...
20. 「**データベースの列の自動ラベル付け**」ページで、「**次へ**」をクリックします。 

21. 「**設定の確認と終了**」ページで、「**ラベルの作成**」を選択します。
...
26. 「**発行する秘密度ラベルを選択**」ページで、「**リンクを発行する秘密度ラベルを選択**」を選択します。
